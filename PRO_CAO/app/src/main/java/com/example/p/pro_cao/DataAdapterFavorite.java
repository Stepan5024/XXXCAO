...
public class DataAdapterFavorite extends RecyclerView.Adapter<DataAdapterFavorite.ViewHolder> {
    ...
    public DataAdapterFavorite(Context context, ArrayList<TaskForRecyclerView> phones) {
        this.tasks = phones;
    ...
    @NonNull
    public DataAdapterFavorite.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = inflater.inflate(R.layout.view_recycler2, parent, false);
        return new ViewHolder(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    @Override
    public void onBindViewHolder(@NonNull final DataAdapterFavorite.ViewHolder viewHolder, final int position) {
